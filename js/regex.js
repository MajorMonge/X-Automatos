...
$(document).ready(function () {
    $('#RegexString').keyup(function () { Regexinator() });
    $('#RegexGrammar').keyup(function () { Regexinator() });
...
function Regexinator() {
    ...
    if (patt == "" || patt == null || patt == undefined) {
        document.getElementById('result-regex').innerHTML = 'Gramática não inserida, não pode analizar null';
